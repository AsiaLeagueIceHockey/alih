    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 py-3 px-4 bg-primary/5 hover:bg-primary/10 rounded-lg transition-colors w-full"
        >
          <Coffee className="w-5 h-5 text-primary/70" />
          <span className="text-sm font-medium text-primary/70">개발자에게 커피 한 잔 후원하기</span>
        </button>
